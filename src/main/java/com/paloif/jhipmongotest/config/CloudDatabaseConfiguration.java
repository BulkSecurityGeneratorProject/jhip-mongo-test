package com.paloif.jhipmongotest.config;
...
@Configuration
@EnableMongoRepositories("com.paloif.jhipmongotest.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.paloif.jhipmongotest.config.dbmigrations");
